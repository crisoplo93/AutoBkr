...
while(True):
    ...
    #print(balance_text)
    #print(text)
    balance = grab_screen(region=(1370, 167, 1470, 195))
    ...
    # else:
    #     down_average = 0
    # if c_up > c_down and up_average >= high:
    #     moves = [1,0]
    # elif c_down > c_up and down_average >= high:
    #     moves = [0,1]
    # else:
    #     moves = [0,0]
    ...
    if prediction[0] >= high and prediction[1] <= low:
        moves = [1, 0]
    elif prediction[1] >= high and prediction[0] <= low:
        moves = [0, 1]
    else:
        moves = [0, 0]
    ...
    if moves == [1, 0]:
        ...
        saldo = grab_screen(region=(1370, 167, 1470, 195))
